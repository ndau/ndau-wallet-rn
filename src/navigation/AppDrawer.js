...
class AppDrawer extends React.Component {
  ...
  session = () => {
    this.closeDrawer()
    this.props.navigation.replace('Drawer', { screen: 'PairingNav' })
  }
  recoverWallet = async () => {
    this.closeDrawer()
  ...
  showSettings = async () => {
    this.closeDrawer()
    this.props.navigation.replace('Drawer', { screen: 'SettingsNav' })
  }
    ...
    return (
      <DrawerContainer logoutHandler={() => this.logout()}>
        <ScrollView>
          ...
          <DrawerEntryItem
            onPress={() => this.props.navigation.replace('Drawer', { screen: 'ContactSupportNav' })}
