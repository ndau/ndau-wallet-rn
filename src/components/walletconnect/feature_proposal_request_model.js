...
const FeatureProposalModal = () => {
  const [checked, setchecked] = useState(true);
  const {
    proposal,
    socketId,
    socketLogin,
    featureProposalData: proposalData,
    appProposalData,
    appProposalModel,
    isApprove,
    accountAddress,
  ...
  // featureProposalData != null ? JSON.parse(featureProposalData) : '';
  ...
  const onReject = async () => {
    try {
      ...
      SessionBloc.setFeatureProposal('', false);
...
export default FeatureProposalModal;
