...
const AppPurposalModal = () => {
  ...
  const onReject = async () => {
    try {
      Socket.emit(
        ...
        {
          proposalId: appPurposalData.proposalId,
  ...
  const onApprove = async () => {
    try {
      ...
      SessionBloc.setAppPurposal('', false, false);
                ...
                <View
                  ...
                  <Text
                    ...
                    <Text style={{fontSize: 15}}>
                      {appPurposalData && appPurposalData.proposalId}
                    </Text>
                  </Text>
                </View>
              </View>
...
export default AppPurposalModal;
