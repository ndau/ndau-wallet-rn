...
const AppProposalModal = () => {
  ...
  const onReject = async () => {
    try {
      Socket.emit(
        ...
        {
          proposalId: appProposalData.proposalId,
          app_socket_id: socketId,
        },
      );
      SessionBloc.setAppProposal('', false);
  ...
  const onApprove = async () => {
    try {
      ...
      SessionBloc.setAppProposal('', false, false);
            ...
            <View style={{flex: 1, marginTop: '-5%', paddingHorizontal: '2%'}}>
              ...
              <View style={{paddingTop: '5%'}}>
                <Text
                  ...
                  Review {isApprove ? 'Proposal Approve' : 'Proposal Reject'}
                </Text>
                ...
                <View
                  ...
                  <Text
                    ...
                    <Text style={{fontSize: 15}}>
                      {appProposalData && appProposalData.proposalId}
                    </Text>
                  </Text>
                </View>
              </View>
...
export default AppProposalModal;
