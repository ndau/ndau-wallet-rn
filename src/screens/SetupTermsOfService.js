...
class SetupTermsOfService extends Component {
  ...
  render () {
    ...
    return (
      <SetupContainer {...this.props} pageNumber={18}>
        ...
        <View>
          ...
          <Text style={styles.legalText}>
            ...
            {'\n'}
            1.4. IF YOU DO NOT AGREE WITH ANY OF THE TERMS HEREIN, KINDLY AND
            IMMEDIATELY CEASE ANY USE OF THE WEBSITE AND/OR, AS APPLICABLE,
            CEASE ANY USE OF THE APPLICATION AND PROMPTLY DELETE IT FROM YOUR
            DEVICE.
            {'\n'}
            1.5. We may amend, change, or replace these Terms, by posting
            updated versions on the Platform or by notifying you by other means.
            All such modifications to the Terms shall become effective upon the
            posting of the revised Terms or by receipt of notification of a
            change to the Terms. If you do not agree to the new or different
            Terms, you must act in accordance with instructions of Section ‎1.4
            above.
          </Text>
          <Text style={styles.legalTextHeading}>{'\n'}2. The Platform</Text>
          <Text style={styles.legalText}>
            ...
            contemplate on issuing, as further detailed on the Platform.
            {'\n'}
            2.2. Users who desire to be eligible to subscribe for the Tokens,
            will be required to provide us with certain information and details
            which may contain personal information. Our collection, processing,
            and use of such personal information is as described under our
            Privacy Notice. However, when subscribing for our tokens, we may
            require you to provide us with additional personal information which
            we do not collect from you while making use of the Platform for the
            General Purpose (the “
            ...
            {'\n'}
            2.3 YOUR USE OF THE PLATFORM DOES NOT INDICATE ANY COMMITMENT THAT
            WE CONSIDER YOU AS ELIGIBLE TO SUBSCRIBE FOR ANY TOKENS.
          </Text>
          <Text style={styles.legalTextHeading}>{'\n'}3. Tokens</Text>
          <Text style={styles.legalText}>
            {'\n'}3.1.{' '}
            ...
            subscribing for the Tokens.
            {'\n'}
            3.3. UNDER NO CIRCUMSTANCES SHOULD YOU DEEM ANY INFORMATION
            PRESENTED ON THE PLATFORM PERTAINING TO THE TOKENS, AND
            SPECIFICALLY, ANY WHITE PAPER WE PROVIDE, AS ANY RECOMMENDATION TO
            PURCHASE, SELL, OR OTHERWISE TRADE IN ANY CRYPTOCURRENCIES
            ...
            PROFESSIONALS PRIOR TO MAKING ANY DECISIONS INVOLVING THE TRADE OF
            ANY CRYPTOCURRENCY.
            {'\n'}
            3.4. SPECIFICALLY, WE MAKE NO COMMITMENT AS TO THE VALUE OF THE
            TOKENS, THEIR ECONOMIC VALUE, NOR THE TRADABILITY OF ANY TOKENS. WE
            ASSUME NO RESPONSIBILITY REGARDING ANY DECISION UNDERTAKEN BY THE
            APPLICABLE BODIES WHICH MAY AFFECT THE VALUE OF THE TOKENS.
            FURTHERMORE, WE MAKE NO WARRANTY REGARDING THE CLASSIFICATION OF THE
            TOKENS (E.G., UTILITY, CURRENCY, EQUITY, OR ANY EQUIVALENT THEREOF),
            SUCH THAT, AMONG OTHER MATTERS, WE CANNOT REASONABLY ADVISE WHICH
            TAX REGIME AND/OR SECURITIES REGULATION SHALL APPLY TO THE TOKENS,
            IF ANY. IT IS YOUR RESPONSIBILITY TO UNDERSTAND THE APPLICABLE
            REGULATION THAT APPLIES TO YOU. HOWEVER, WE MAY, AT OUR SOLE
            DISCRETION, REQUIRE YOU TO PROVIDE US WITH CERTAIN INFORMATION /
            REPRESENTATIONS (SUCH AS YOUR STATUS AS AN ACCREDITED INVESTOR) IN
            ORDER FOR US TO DETERMINE WHETHER OR NOT TO ALLOW YOU TO SUBSCRIBE
            FOR OUR TOKENS.
          </Text>
          <Text style={styles.legalTextHeading}>
          ...
          <Text style={styles.legalText}>
            ...
            EXCLUSIVELY FOR YOU.
            {'\n'}
            6.2. <Text style={styles.legalTextBold}>Legal Age</Text>. You are
            not allowed to make any use of the Platform in the event that you
            are under the age of 16.
            {'\n'}
            6.3. <Text style={styles.legalTextBold}>Compliance</Text>.
            Notwithstanding anything to the contrary herein, you agree to abide
            by all applicable local, state, national, and international laws and
            regulations in regard to your use of the Platform and any content
            offered therein. For the avoidance of doubt, the ability to access
            our Platform does not necessarily mean that your use is permitted
            under relevant laws, regulations, and directives.
            {'\n'}
            6.4. <Text style={styles.legalTextBold}>Additional Policies</Text>.
            In addition to the foregoing, while using the Platform, you will
            strictly adhere to the respective Platform policies published by us
            from time to time, such that you should not:
            ...
            otherwise published by us.
            {'\n'}
            6.5. <Text style={styles.legalTextBold}>External Links</Text>. The
            Platform may contain external links to third-party websites (“
          ...
          <Text style={styles.legalText}>
            {'\n'}
            7.1. <Text style={styles.legalTextBold}>Ownership</Text>. As between
            you and Oneiro, other than Tokens that you have subscribed in full
            ...
            owners.
            {'\n'}
            7.2. <Text style={styles.legalTextBold}>Right to Use</Text>. You may
          ...
          <Text style={styles.legalText}>
            ...
            {'\n'}
            8.2. DESPITE MAINTAINING REASONABLE MEASURES TO SECURE AND PROTECT
            YOUR ACCOUNT INFORMATION REGARDING USERS’ ACCESS TO THE PLATFORM, WE
            CANNOT ENSURE FULL PROTECTION FROM EXPOSURE DUE TO MALICIOUS ACTS,
            AND THEREFORE ARE NOT BE LIABLE FOR ANY DAMAGES, WHETHER DIRECT,
            INDIRECT, INCIDENTAL, OR CONSEQUENTIAL, INCURRED BY USERS DUE TO
            EXPOSURE OF ACCOUNT CONTENTS OR INFORMATION REGARDING USERS’ ACCESS.
            YOU ARE HIGHLY ENCOURAGED TO MAINTAIN REQUISITE PROTECTION FOR YOUR
            DEVICES, SUCH AS APPLYING UPDATES TO YOUR SOFTWARE AND HARDWARE WHEN
            THEY BECOME AVAILABLE, AND MAINTAINING UP-TO-DATE ANTIVIRUS,
            ANTI-MALWARE, OR ANTI-PHISHING SOFTWARE.
          </Text>
          <Text style={styles.legalTextHeading}>
          ...
          <Text style={styles.legalText}>
            ...
            PURPOSE, AND NON-INFRINGEMENT OF ANY RIGHTS.
            {'\n'}
            9.2. WITHOUT LIMITING THE ABOVE, WE MAKE NO WARRANTY (I) THAT THE
            PLATFORM, ANALYSIS UNDER ANY OF OUR WHITEPAPER AND/OR ANY OTHER
            CONTENT WILL MEET YOUR REQUIREMENTS, OR WILL BE UNINTERRUPTED,
            CONTINUOUS, TIMELY, SECURE, ACCURATE, CORRECT, COMPLETE OR
            AVAILABLE, INCLUDING WITHOUT LIMITATIONS, IN CONNECTION WITH ANY
            SERVER RUNTIME AND/OR DOWNTIME (INCLUDING ANY INTERRUPTION OR
            CESSATION OF ANY DATA RECEIVED AND/OR OTHERWISE TRANSMITTED WITHIN
            THE SCOPE OF THE USE OF THE PLATFORM), SERVER SECURITY MEASURES,
            CONTENT PROVIDED BY OTHER USERS AND/OR YOURSELF (INCLUDING ANY
            PERSONAL, FINANCIAL AND/OR ANY OTHER INFORMATION) OR FOR ANY LOSS OR
            DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF ANY CONTENT
            POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE PLATFORM,
            NOR (II), THAT THE PLATFORM SHALL BE FREE OF VIRUSES, TROJAN HORSES
            AND/OR ANY OTHER FORM OF MALWARE UTILIZED BY THIRD PARTIES, OR
            OTHERWISE BE FREE OF ANY ERRORS AND/OR BUGS.
            {'\n'}
            9.3. WE DO NOT ENDORSE OR APPROVE ANY CONTENT PROVIDED BY ANY PARTY
            OTHER THAN US. WE DO NOT WARRANT OR MAKE ANY REPRESENTATIONS
          ...
          <Text style={styles.legalText}>
            ...
            YOUR OR OTHER USERS’ STATEMENTS OR CONDUCT).
            {'\n'}
            10.2. THE CUMULATIVE LIABILITY TO YOU FOR ANY AND ALL CLAIMS
            RELATING TO THE PLATFORM, SHALL BE LIMITED TO THE LOWER OF (I) THE
            TOTAL AMOUNT PAID BY USER AS CONSIDERATION FOR THE USE OF THE
            PLATFORM (IF PAID, AND SPECIFICALLY EXCLUDING ANY AMOUNTS PAID BY
            SUCH USER IN CONNECTION WITH THE SUBSCRIPTION OF ANY TOKENS), OR
            (II) USD $100.
          </Text>
          ...
          <Text style={styles.legalText}>
            ...
            , INCLUDING OUR DIRECTORS AND OFFICERS, EMPLOYEES, SERVICE
            PROVIDERS, AND/OR ANY AFFILIATES, FOR CLAIMS, SUITS, LOSSES AND/OR{' '}
          ...
          <Text style={styles.legalText}>
            ...
            behalf of others).
            {'\n'}
            12.2. These Terms are governed by the General Corporation Law of the
            State of Delaware. You hereby consent to the exclusive jurisdiction
            and venue of courts in Wilmington, New Castle County, Delaware
            19801, U.S.A. in all disputes arising out of or relating to the use
            of the Platform. Use of the Platform is unauthorized in any
            ...
            relationship exists between you and Oneiro as a result of these
            Terms and/or any use of the Platform (including any subscription for
            Tokens).
            {'\n'}
            12.3. Our performance of these Terms is subject to existing laws and
            legal process, and nothing contained in these Terms is in derogation
            of our right / obligation to comply with governmental, court and law
            ...
            {'\n'}
            12.5. Unless otherwise specified herein, these Terms constitute the
            entire agreement between you and Oneiro with respect to the Platform
            ...
            Oneiro with respect to the Platform.
            {'\n'}
            12.6. These Terms constitute the entire agreement between the User
            and Oneiro with respect to the Platform and it supersedes all prior
            or contemporaneous communications and proposals, whether electronic,
            oral or written, between the User and Oneiro with respect to the
            Platform.
          </Text>
          <Text style={styles.legalTextHeading}>{'\n'}13. Assignment</Text>
          <Text style={styles.legalText}>
