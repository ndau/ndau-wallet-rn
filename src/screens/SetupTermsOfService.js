          ...
          >
            ...
            <View>
              ...
              <Text style={styles.legalText}>
                ...
                ”), AS FURTHER
                DETAILED ON [HTTPS://NDAU.IO] (THE “<Text
                  style={styles.legalTextBold}
                >
                  GENERAL PURPOSE
                </Text>”).
                {'\n'}
              ...
              <Text style={styles.legalText}>
                ...
                . You understand that we have no control over Third-Party Vendors and their
              ...
              <Text style={styles.legalText}>
                ...
                6.2.
                {' '}
                <Text style={styles.legalTextBold}>Legal Age</Text>
                . You are not allowed
                to make any use of the Platform in the event that you are under the age of 16.
                {'\n'}
                6.3.
                {' '}
                <Text style={styles.legalTextBold}>Compliance</Text>
                . Notwithstanding
                ...
                6.5.
                {' '}
                <Text style={styles.legalTextBold}>External Links</Text>
                . The Platform
              ...
              <Text style={styles.legalText}>
                ...
                7.1.
                {' '}
                <Text style={styles.legalTextBold}>Ownership</Text>
                . As between you and
                ...
                7.2.
                {' '}
                <Text style={styles.legalTextBold}>Right to Use</Text>
                . You may only use
              ...
              <Text style={styles.legalText}>
                ...
                OF, ACCESS TO, OR RELIANCE ON THE
                {' '}
                <Text style={styles.legalTextBold}>PLATFORM</Text>
              </Text>
              <Text style={styles.legalTextHeading}>
