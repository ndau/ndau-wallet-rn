    ...
    return (
      <View style={styles.container}>
        <ScrollView style={styles.contentContainer}>
          ...
          <View>
            <Text style={styles.text}>
              Currently, ndau is only available to accredited investors. You will need to have made
              your purchase through our site and have you six-digit ID code ready in order to access
              this app before launch.
            </Text>
          </View>
          <View>
            <Text style={styles.text}>
              To get you started securely, you will create a new wallet, protect this app with
              password, and create a twelve-word phrase which you will need in order to restore your
              wallet if you lose access to it.
            </Text>
          </View>
        </ScrollView>
