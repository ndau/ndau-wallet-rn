...
const makeComponent = () => (
  <SetupRecoveryPhrase navigator={navigator} parentStyles={styles} />
)
...
describe('testing SetupRecoveryPhrase...', () => {
  it('calls keyaddrWordsFromBytes as expected', () => {
    ...
    this.wrapper.update()
    expect(
      NativeModules.KeyaddrManager.keyaddrWordsFromBytes.mock.calls
    ).toEqual([[AppConstants.APP_LANGUAGE, 'dGVzdGluZ3dlc3Rpbmdh']])
  })
})
